...
SetupWebPage::AddModule(
    __FILE__,
    'br-peripherals-bridge-for-teemip-ip-mgmt/3.2.2',
    array(
        // Identification
        //
        ...
        //
        'dependencies' => array(
            'br-peripherals/3.2.2||teemip-ip-mgmt/3.0.0',
            'br-peripherals/3.2.2||teemip-config-mgmt-adaptor/3.0.0',
            'br-peripherals/3.2.2',
        ),
        'mandatory' => false,
